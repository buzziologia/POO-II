...
class Pedido:
  def __init__(self, clientes, sabores, tamanhos, adicionais, pedidos):
      self.clientes = clientes
      self.sabores = sabores
      self.tamanhos = tamanhos
      self.adicionais = adicionais
  ...
  def visualizar_pedido(self):
    ...
    if self.pedidos:  # Verifica se a lista de pedidos não está vazia
          ...
          while True:
              try:
                  ...
                  if opcao == 1:
                    ...
                    pedido = Pedido(clientes, sabores, tamanhos, adicionais, pedidos)
                    pedido.menu_pedido()
                  elif opcao == 6:
